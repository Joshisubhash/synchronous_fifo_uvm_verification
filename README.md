# synchronous_fifo_uvm_verification
UVM verification environment for a synchronous FIFO including driver, monitor, scoreboard, coverage and multiple test scenarios.
